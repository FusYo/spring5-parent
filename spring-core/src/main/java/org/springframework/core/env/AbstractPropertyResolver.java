...
public abstract class AbstractPropertyResolver implements ConfigurablePropertyResolver {
	...
	private String doResolvePlaceholders(String text, PropertyPlaceholderHelper helper) {
		//PlaceholderResolver placeholderResolver = this::getPropertyAsRawString;
		//PlaceholderResolver是一个函数式接口
		//return helper.replacePlaceholders(text, this::getPropertyAsRawString);
		//TODO????怎么给PlaceholderResolver初始化值得
		return helper.replacePlaceholders(text,new PropertyPlaceholderHelper.PlaceholderResolver() {
            //回调方法-即PropertyPlaceholderHelper类parseStringValue()方法调用resolvePlaceholder()方法，会执行此处代码
			@Override

...
public abstract class AbstractEnvironment implements ConfigurableEnvironment {
	...
	//执行了public AbstractEnvironment()之后，这里面已经拥有了系统和环境的配置信息
	private final MutablePropertySources propertySources = new MutablePropertySources();
	//赋值给PropertySourcesPropertyResolver类中PropertySources propertySources属性
	...
	//以允许子类提供或操作{@link PropertySource}实例。
	public AbstractEnvironment() {
		//new一个AbstractEnvironment对象的时候，new了一个MutablePropertySources对象
		//然后调用子类customizePropertySources()方法的时候，调用propertySources.addLast()方法将属性信息添加到MutablePropertySources中

 ...
 */
/**
 * 对BeanFactory接口的扩展。接口将由能够自动装配的bean工厂实现，只要它们想为现有的bean实例公开此功能
 * 这个BeanFactory子接口不是用来正常使用的，应该坚持使用BeanFactory或ListableBeanFactory这些典型用例
 * @author fussen
 * @date Jun 26, 2020 11:21:28 PM
 */
